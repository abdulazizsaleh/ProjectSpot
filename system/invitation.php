...
if ($row != null) {
  ...
  $invitation = '<div class="well text-center" style="width: 40%; margin: auto; ">
                  ...
                  <a href="system/invitationResponse.php?response=0" style="margin:5px;" type="button" name="button" class="btn btn-danger">Reject</a>
                  <a href="system/invitationResponse.php?response=1" style="margin:5px;" type="button" name="button" class="btn btn-success">Accept</a>
                </div>';
